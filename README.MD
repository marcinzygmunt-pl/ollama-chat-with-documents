<h1 align="center" id="title"> RAG AI Ollama</h1>

<p id="description">Sample AI Assistant to prompt your documents. Documents could be stored in inMemory or pgVector repository.</p>
